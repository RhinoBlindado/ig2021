 ...
 */
void _cylinderTex::initialize(float height, float radius, int hCuts, int vCuts, int rCuts)
{
 ...
 */
void _cylinderTex::rotation(int rCuts)
{
 ...
 * @param rCuts
 */
void _cylinderTex::genTriangles(int rCuts)
{
 ...
 * @param vCuts
 */
void _cylinderTex::mapTexture(int rCuts, int hCuts, int vCuts)
{
