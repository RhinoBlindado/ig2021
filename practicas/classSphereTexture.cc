 ...
 */
void _sphereTex::initialize(float radius, int vCuts, int rCuts)
{
 ...
 *          be normalized.
 */
void _sphereTex::calculateVertNormals()
{
 ...
 */
void _sphereTex::calculateTrigNormals()
{
 ...
 */
void _sphereTex::rotation(int rCuts)
{
 ...
 * @param rCuts     Number of cuts of the radius.
 */
void _sphereTex::genTriangles(int rCuts)
{
    int vertSize = Vertices.size();
 ...
 * @param rCuts     Number of cuts of the radius.
 */
void _sphereTex::mapTexture(int rCuts)
{
    int vertSize = Vertices.size();
    int plySizeVert = vertSize / rCuts;
